...
part 'database.g.dart'; // Will be generated by build_runner

@DriftDatabase(tables: [Users, Devices, Rabbis, UserRabbiPermissions, Transfers], include: {'tables.dart'})
