...
import 'package:kol_hashiurim/features/admin_panel/device_management_tab.dart';
import 'package:kol_hashiurim/features/admin_panel/rabbi_management_tab.dart';
import 'package:kol_hashiurim/features/admin_panel/user_management_tab.dart';
import 'package:kol_hashiurim/features/admin_panel/widgets/settings_tab.dart';
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'מערכת זו, פרי הפיתוח של זה קל מערכות, היא פלטפורמה ייעודית לניהול והעברה מאובטחת של הקלטות שיעורי תורה. התוכנה פותחה במיוחד כדי לייעל ולהסדיר את תהליך הוספת השיעורים החדשים למאגר קול הלשון',
                      textAlign: TextAlign.center,
                    ),
